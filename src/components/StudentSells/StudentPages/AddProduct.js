...
const submitProduct = (e) => { 
    ...
    const student_name = localStorage.getItem('auth_name')
    console.log(addProduct); 
    ...
    formData.append('subcategory', addProduct.subcategory ? addProduct.subcategory : searchcourse.subcategory); 
    ...
    axios.post(`/api/add-studentproduct`, formData).then(res=> { 
        ...
        <div className="container-fluid px-4">
            <div className="card mt-4">
                <div className="card-header">
                    <h3>Add Product</h3>
                    <Link to = "/student-sell/view-product" className='btn btn-dark btn-sm float-end'>View Product</Link>
                </div>
